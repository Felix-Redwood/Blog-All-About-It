...
def get_posts(request):
    ...
    published prior to 'now' and render them to the 
    'blogposts.html' template."""
    """Using _lte means that we search for 'less than or equal to'."""
...
def post_detail(request):
    ...
    the Post Id (pk) and render it to the 'postdetail.html'
